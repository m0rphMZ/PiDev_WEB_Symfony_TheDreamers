 ...
 * Invite
 *
 * @ORM\Table(name="invite", indexes={@ORM\Index(name="fk_artiste", columns={"artiste_id"}), @ORM\Index(name="fk_event_in", columns={"event_id"}), @ORM\Index(name="fk_inviter", columns={"inviter_id"})})
 * @ORM\Entity
 */
class Invite
{
